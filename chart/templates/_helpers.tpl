...
helm.sh/chart: {{ include "eventrouter.chart" . }}
app: {{ include "eventrouter.name" . }}
{{ include "eventrouter.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "eventrouter.selectorLabels" -}}
app.kubernetes.io/name: {{ include "eventrouter.name" . }}
